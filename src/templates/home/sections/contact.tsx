            ...
            <div className="flex-1 w-full max-w-xl min-w-0 mx-auto lg:mx-0">
                <FadeIn delay={0.3}>
                    {isSubmitSuccessful ? (
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6 bg-black/5 p-5 sm:p-6 md:p-10 border-4 border-black shadow-[10px_10px_0_0_rgba(0,0,0,1)] md:shadow-[16px_16px_0_0_rgba(0,0,0,1)] md:hover:shadow-[8px_8px_0_0_rgba(0,0,0,1)] md:hover:translate-x-2 md:hover:translate-y-2 transition-all duration-300 ease-out">
