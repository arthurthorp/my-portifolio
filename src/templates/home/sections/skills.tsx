...
export const Skills = () => {
    ...
    const renderSkillRow = (title: string, skills: string[]) => (
        <SlideUp className="border-t-2 border-foreground/10 py-10 group hover:bg-muted">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center gap-8 px-6 md:px-12 lg:px-24">
                <Typography variant="h4" className="w-48 shrink-0 text-foreground/40 group-hover:text-accent uppercase">
                    {title}
                </Typography>
