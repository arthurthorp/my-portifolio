...
const metadataByLang: Record<Lang, { title: string; description: string }> = {
  pt: {
    title: 'Arthur Tavares | Desenvolvedor Full-Stack',
    description:
      'Portfólio de Arthur Tavares, desenvolvedor full-stack focado em arquitetura escalável e produtos digitais de alta qualidade.',
  },
  en: {
