# Plataforma de Resgate de Cupons e Sincronização de Usuários
...
- Integração front-back desacoplada
- Processamento de dados síncrono para captura de leads
- Proteção de dados e consistência na aplicação de cupons

### Tecnologias e Serviços Utilizados

- **Node.js (BFF)** para roteamento de APIs e lógica de vinculação de cupons.
- **React** para desenvolvimento da interface gráfica e formulários de captura de leads.
- **MasterData VTEX** para cadastro, sincronização e registro da utilização dos cupons.
- **Checkout seguro** com camadas adicionais de proteção e validações.
- Monitoramento e logs para auditoria da campanha e resolução de erros.
