...
The system consumes high volumes of data from a legacy **SAP ERP**, processes events at scale, and distributes consolidated data across multiple corporate domains in a resilient and low-latency manner.
...
- **Apache Kafka** for SAP event ingestion and streaming.
